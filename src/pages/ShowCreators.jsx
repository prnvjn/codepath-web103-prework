  ...
  return (
    <div className="cardsGrid">
      ...
      <article key={creator.id} >
        ...
        {creator.creator_img.length !==0? <div  style={{backgroundImage:`url(${creator.creator_img})`,backgroundSize: 'cover',
      backgroundPosition: '25% 25%',
      backgroundRepeat: 'no-repeat',
      width: '100%',  position: 'relative',
      height:"100px",marginBottom:"1rem",borderRadius:"10px",
    
      zIndex: 1}} >

        </div>:<div style={{background: "linear-gradient(90deg, #00ffff 0%, #ff00ff 100%)", height:"100px",marginBottom:"1rem",borderRadius:"10px"}}></div> }
...
<span className="icons">
  {/* edit svg */}
  <Link to={creator.id+"/edit"} data-tooltip="Edit"state={creator} className="contrast">
  ...
  {/* view svg */}
  <Link to={"/"+creator.id} state={creator} className="contrast" data-tooltip="View">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="svg">
...
<g>
    ...
    {/* <a href={"https://www.youtube.com/@"+creator.youtube_URL} id="meta" target="_blank"  rel="noopener noreferrer">@{creator.youtube_URL}</a> */}
    </span> ): null }
    ...
    {/* <a href={"https://www.instagram.com/"+creator.insta_URL} id="meta" target="_blank"  rel="noopener noreferrer"> @{creator.insta_URL}</a> */}
    </span>: null }
    ...
    {/* <a href={"https://twitter.com/"+creator.twitter_URL} id="meta" target="_blank"  rel="noopener noreferrer">@{creator.twitter_URL}</a> */}
    </span>: null }
</div>
